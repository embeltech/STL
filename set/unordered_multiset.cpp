...
// unordered_multiset-> Not unique & Not sorted elements which cannot be modified. Only can be removed or added.

void printSet(const std::unordered_multiset<std::string>& setData)
{
    std::cout<<"----------------------------\n";
...
int main()
{
    std::unordered_multiset<std::string> mSetData;
